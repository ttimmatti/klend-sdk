...
exports.DISCRIMINATOR = Buffer.from([10, 214, 219, 139, 205, 22, 251, 21]);
exports.layout = borsh.struct([borsh.u64("amount")]);
function withdrawRewards(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
        {
