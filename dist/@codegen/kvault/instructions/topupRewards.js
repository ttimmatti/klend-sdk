...
exports.topupRewards = topupRewards;
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([127, 147, 49, 137, 58, 137, 103, 56]);
exports.layout = borsh.struct([borsh.u64("amount")]);
function topupRewards(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
...
//# sourceMappingURL=topupRewards.js.map