...
exports.redeemInKind = redeemInKind;
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([102, 58, 189, 252, 192, 219, 140, 89]);
exports.layout = borsh.struct([
    borsh.u64("sharesAmount"),
]);
function redeemInKind(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
...
//# sourceMappingURL=redeemInKind.js.map